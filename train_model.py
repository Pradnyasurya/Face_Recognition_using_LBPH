...
test_img=cv2.imread(r'rw (44).jpg')  #Give path to the image which you want to test
...
face_recognizer.save(r'training-data\trainingData.yml') #It will save the trained model. Just give path to where you want to save
